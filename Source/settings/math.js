...
Mario10Fun.Mario10Fun.settings.math = {
    "equations": {
        /**
         ...
         * 
         * @param {Thing} thing   A player close to a castl eaxe.
         * @param {Thing} other   A castle axe that can defeat Bowser.
         * @returns {Boolean} Whether the player is both alive and close enough to the axe.
         */
